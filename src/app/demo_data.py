...
def build_demo_user_profiles() -> dict[str, DemoUserProfile]:
    ...
    profiles = [
        ...
        DemoUserProfile(
            ...
            display_name="Maya | Late-Night Melancholy",
        ...
        DemoUserProfile(
            ...
            display_name="Guest | New Listener",
